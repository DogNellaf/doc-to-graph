graph [
  ...
  node [
    id 733
    label "10.12.92 :arg1 ( and_1 :op1 ( country_0 :name ( name_2 :op1 "
  ]
  node [
    id 734
    label "tunisia"
  ...
  node [
    id 863
    label " ) :op2 ( depend-01_2 ) :time ( date-entity_1 :day 22 :month 4 :year 1993 ) :op2 ( city :name ( name_2 :op1 "
  ]
  node [
    id 864
    label "nauru"
