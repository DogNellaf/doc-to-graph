graph [
  ...
  node [
    id 363
    label " disease_1 ) ) :op4 ( syndrome :mod ( shock-01 :mod ( toxic ) ) ) :quant ( myriad ) :arg1-of ( identify-01 :arg1-of ( new-01 ) ) :example ( and_1 :op1 ( disease_2 :name ( name_2 :op1 "
  ]
  node [
    id 364
